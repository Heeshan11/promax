...
export var MainCategories;
(function (MainCategories) {
    MainCategories["Commercial"] = "Commercial";
    MainCategories["Hospitality"] = "Hospitality";
    MainCategories["Educational"] = "Educational";
    MainCategories["Healthcare"] = "Healthcare";
    MainCategories["PublicSpaces"] = "Public Spaces";
})(MainCategories || (MainCategories = {}));
export var subCategories;
(function (subCategories) {
    subCategories["Seating"] = "Seating";
    subCategories["Office"] = "Office";
    subCategories["Desk"] = "Desk";
    subCategories["Street"] = "Street";
    subCategories["Restaurant"] = "Restaurant";
...
export const bio = {
    ...
    description: "We remain excited about the future  and committed to our mission of driving  discipline progress and innovation",
...
const generateProducts = (category, count, imagePattern) => {
...
const subGenerateProducts = (category, count, imagePattern, imgType = "jpg") => {
    return Array.from({ length: count }, (_, index) => ({
        uid: `${category.slice(0, 3)}${index + 1}`,
        id: uniqueIdCounter + 1,
