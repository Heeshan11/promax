...
const Collaboration = () => {
    ...
    return (
        <section className="flex w-4/5 mx-auto flex-col md:flex-row justify-between bg-gradient-to-tl from-gray-900 to-[#0404063b] p-6 py-12 md:py-20 text-white rounded-md">
            <div className="w-full md:w-2/3 mx-auto text-center md:text-left">
                <h1 className="mb-4 font-heading text-xl sm:text-2xl md:text-3xl font-semibold leading-tight text-dark dark:text-white sm:text-[38px]">
            ...
            <div className="w-full md:w-1/3 flex justify-center md:justify-start items-center mt-4 md:mt-0">
                <a
                    href={whatsappLink}
                    target="_blank"
